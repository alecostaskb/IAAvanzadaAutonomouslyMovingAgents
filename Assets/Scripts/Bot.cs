...
public class Bot : MonoBehaviour
{
    ...
    private void CleverHide()
    {
        ...
        //calculate a ray to hit the hiding spot's collider from the opposite side to where the target is located
    ...
    {
        //if the target is within 10 units of the agent then consider it within range to affect the agent's behaviour
